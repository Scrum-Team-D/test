...
//  TimerApp
//
//  Created by Yosuke Nozaki on 2019/12/06.
//  Copyright © 2019 Yosuke Nozaki. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let settinngs = UserDefaults.standard
        settinngs.register(defaults: [settingKey:60])
    }
    ...
    func displayUpdate() -> Int {
        ...
        let remainSeconds = timeValue - duration
